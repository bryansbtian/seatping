...
const en = {
  ...
  "floor.live.noCapacityBody":
    "No single table or configured table combination can accommodate this party.",
  "floor.live.noAvailability": "No Table Available",
  "floor.live.noAvailabilityBody":
    "A configured table setup can accommodate this party, but it is currently unavailable.",
  ...
  "floor.assign.combinedSeats": "{n} Combined Seats",
  "floor.assign.combination": "Combination",
  "floor.combos.title": "Table Combinations",
  "floor.combos.empty": "No Combinations Yet",
  "floor.combos.hint": "Pick two or more tables to seat parties that no single table can take.",
  "floor.combos.create": "Create Combination",
  "floor.combos.delete": "Delete Combination",
  "floor.combos.seats": "{n} Seats",
  "floor.combos.toast.created": "Combination Created",
  "floor.combos.toast.deleted": "Combination Deleted",
  "floor.combos.needTwo": "Pick at least two tables.",
  "floor.assign.noTables": "No table can take this party right now.",
...
const id: Partial<Record<TKey, string>> = {
  ...
  "floor.live.noCapacityBody":
    "Tidak ada meja tunggal atau gabungan meja yang muat untuk tamu ini.",
  "floor.live.noAvailability": "Belum Ada Meja Tersedia",
  "floor.live.noAvailabilityBody": "Ada susunan meja yang muat, tetapi saat ini belum tersedia.",
  ...
  "floor.assign.combinedSeats": "{n} Kursi Gabungan",
  "floor.assign.combination": "Gabungan",
  "floor.combos.title": "Gabungan Meja",
  "floor.combos.empty": "Belum Ada Gabungan",
  "floor.combos.hint": "Pilih dua meja atau lebih untuk tamu yang tidak muat di satu meja.",
  "floor.combos.create": "Buat Gabungan",
  "floor.combos.delete": "Hapus Gabungan",
  "floor.combos.seats": "{n} Kursi",
  "floor.combos.toast.created": "Gabungan Dibuat",
  "floor.combos.toast.deleted": "Gabungan Dihapus",
  "floor.combos.needTwo": "Pilih setidaknya dua meja.",
  "floor.assign.noTables": "Belum ada meja yang bisa menampung tamu ini.",
