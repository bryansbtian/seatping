...
const PRICE_IDS = {
    ...
    "Starter Yearly": process.env.STRIPE_PRICE_STARTER_YEARLY ?? "price_1SEZrNDHwj4NMuGR1cZEJREy",
    "Professional Monthly": process.env.STRIPE_PRICE_PRO_MONTHLY ?? "price_1SEZrlDHwj4NMuGRJKbFthwJ",
    "Professional Yearly": process.env.STRIPE_PRICE_PRO_YEARLY ?? "price_1SEZs8DHwj4NMuGRC7G1ndkN",
};
const PLAN_RULES = {
    Starter: {
        plan: "Starter",
